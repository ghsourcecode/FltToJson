...
/**
 * 可配置到web.xml中，在tomcat启动时，调用contextInitialized
 * @author elitel0329
 *
 */
public class LoadArcGISLicenceOnStartUp extends ContextLoaderListener {
	@Override
	...
	public void contextDestroyed(ServletContextEvent event) {
		System.out.println("coustomer contextloaderlistener unload……");
	}
	...
	private static void bootstrapArcobjectsJar(){
        ...
        System.out.println(sysloader.getURLs());
